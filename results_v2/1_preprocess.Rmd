...
4) the tumor are heterogenous between patients, so merging them together doesn't seem like a useful way to investiage the heterogeneity. 

Instead of using alignment the data will be presented unaligned. Unlike studies in development or cell-type identificaiton studies, very few visualizations will require UMAPs. The workflow for analysis will be as follows:
...
Suggest removing cells with > 30% mitochondrial UMIs, > 40K UMIs. Also removing WNT sample from dataset as not enough samples/cells for a rigorous analysis. 
...
Annotate samples and assign colors to each sample. ALso merge replicates from 966
...
new_ids <- c(
 ...
 "13" = "b-cells",
 "14" = "malignant",
 "15" = "oligodendrocytes_astrocytes",
 "16" = "malignant",
 "17" = "malignant"
 )
