...
fig_dir <- "figs"
qc_figs <- file.path(fig_dir, "qc")
mkrs_dir <- "markers"
tbls_dir <- "tables"
walk(c(fig_dir, mkrs_dir, tbls_dir, qc_figs),
...
save_plot(file.path(qc_figs, "prop_mito.pdf"),
          p, base_asp = 1.75)
p
```
...
save_plot(file.path(qc_figs, "ngene.pdf"),
          p, base_asp = 1.75)
p
```
...
save_plot(file.path(qc_figs, "numi.pdf"),
          p, base_asp = 1.75)
p
```
...
save_plot(file.path(qc_figs, "umi_v_prop_mito.pdf"),
          plt,
          nrow = 6,
          ncol = 6)
...
scbp::write_markers_xlsx(.,
                   file.path(xcel_dir, "coarse_cluster_markers_all_data.xlsx"))
...
save_plot(file.path(qc_figs, "cluster_diversity.pdf"), p, base_asp = 1.2, )
```
...
new_ids <- c(
  "10" = "lymphocytes",
  "0" = "macrophage_monocytes",
  "14" ="oligodendrocytes_astrocytes_other",
  "18" = "macrophage_monocytes"
)
...
plot_umap(so, "coarse_cell_type", .cols = scbp:::palette_OkabeIto)
```
