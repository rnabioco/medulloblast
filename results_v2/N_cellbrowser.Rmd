...
```{r}
so <- readRDS(file.path("objects", "gp3_only.rds"))
...
scbp::make_cellbrowser(so, 
                 ...
                 outdir = cb_outdir,
                 marker_file = "markers/harmony_markers_gp3_only.tsv",
                 ident = "clusters_aligned",
                 embeddings = def_embeddings(so),
                 skip_expr_matrix = TRUE
)
...
```{r}
so <- readRDS(file.path("objects", "gp4_only.rds"))
...
scbp::make_cellbrowser(so, 
                 ...
                 outdir = cb_outdir,
                 marker_file = "markers/harmony_markers_gp4_only.tsv",
                 ident = "clusters_aligned",
                 embeddings = def_embeddings(so),
                 skip_expr_matrix = TRUE
)
...
scbp::build_cellbrowser(datasets, 
