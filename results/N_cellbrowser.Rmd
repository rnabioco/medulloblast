...
make_cellbrowser(so, 
            ...
            "subgroup"), 
                 ...
                 description = list(    
                   ...
                   description = "Only neoplastic cells are shown, includes WNT subgroup. There are both unaligned and aligned projections. Includes cell type labels defined from examining all tumors in a harmonized projection, and cell types defined by harmonizing each subgroup independently."
                 )
)
